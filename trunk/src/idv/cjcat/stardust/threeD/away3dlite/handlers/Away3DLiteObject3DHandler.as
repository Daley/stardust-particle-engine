package idv.cjcat.stardust.threeD.away3dlite.handlers {
	 ...
	 */
	public class Away3DLiteObject3DHandler extends ParticleHandler {
		
		public function Away3DLiteObject3DHandler(container:ObjectContainer3D = null) {
		...
		override public function particleAdded(particle:Particle):void {
			...
			particle.dictionary[Away3DLiteObject3DHandler] = container;
		}
